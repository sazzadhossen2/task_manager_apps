...
bool gettaskcountlist=false;
  ...
  Future<void>getTaskcountsummarylist()async{
    ...
    final Networkresponce responce = await Networkcoller().getrequest(Urls.gettasksummary);
    if(responce.isSuccess){
      taskcountsummarymodel =Taskcountsummarymodel.fromJson(responce.jsonresponce);
    }
...
Future<void>getnewscreen()async{
 ...
 final Networkresponce responce = await Networkcoller().getrequest(Urls.getnewtask);
  if(responce.isSuccess){
