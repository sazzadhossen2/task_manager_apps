...
bool _loginprogress=false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Backgroundimage(child: SafeArea(
        child: Padding(
          ...
          child: SingleChildScrollView(
           ...
           const   SizedBox(height: 80,),
                  ...
                  Row(
                    ...
                    children: [
                      Text("Dont have an account?",style: TextStyle(fontSize: 16,color: Colors.black54,fontWeight: FontWeight.w600),),
                      TextButton(onPressed: (){
  ...
  Future <void>login()async{
    ...
    Networkresponce responce =await Networkcoller().Postrequest(Urls.login,body: {
    ...
    if(responce.isSuccess){
      await Authcontroller.saveuserinformation(responce.jsonresponce["token"],Data.fromJson(responce.jsonresponce["data"]));
